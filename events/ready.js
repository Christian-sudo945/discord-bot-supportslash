...
client.on("ready", () => {
    ...
    console.log(`──────────────────────────────────────────
➤ | ${client.user.tag} Online! | Developed By Xenn1337
──────────────────────────────────────────`)
    client.user.setActivity(config.botStatus || "Developed Xenn1337");

    process.title = config.botStatus + " | Developed By Xenn1337"
});